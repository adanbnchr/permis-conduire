...
class CategorieController extends BaseController {
    ...
    public function indexAction() {
        ...
        return $this->render('AppBundle:generic:tableau.html.twig', array(
                    'data' => $categories, 'fields' =>$this->getFields(), 'keys' => $this->getKeys()
        ));
    }
    ...
    public function newAction(Request $request) {
        ...
        return $this->render('AppBundle:categorie:new.html.twig', array(
                    'categorie' => $categorie,
    ...
    public function showAction(Categorie $categorie) {
        ...
        return $this->render('AppBundle:generic:show.html.twig', array(
                    'categorie' => $categorie,
    ...
    public function editAction(Request $request, Categorie $categorie) {
        ...
        return $this->render('AppBundle:categorie:edit.html.twig', array(
                    'categorie' => $categorie,
